...
namespace BlockchainDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            phillyCoin.AddBlock(new Block(DateTime.Now, null, "{sender:MaHesh,receiver:Henry,amount:10}"));
            phillyCoin.AddBlock(new Block(DateTime.Now, null, "{sender:Henry,receiver:MaHesh,amount:5}"));
            phillyCoin.AddBlock(new Block(DateTime.Now, null, "{sender:Henry,receiver:MaHesh,amount:5}"));
            ...
            //phillyCoin.Chain[1].Data = "{sender:MaHesh,receiver:Henry,amount:1000}";
